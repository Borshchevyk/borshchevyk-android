    ...
    LaunchedEffect(Unit) {
        viewModel.effect.collect { effect ->
            when (effect) {
                ...
                is ProfileEffect.NavigateToEditPrivacy -> onNavigateToEditPrivacy()
                is ProfileEffect.LogoutSuccess -> onLogoutSuccess()
            }
        }
    }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = { viewModel.handleIntent(ProfileIntent.OpenEditProfile) }) {
